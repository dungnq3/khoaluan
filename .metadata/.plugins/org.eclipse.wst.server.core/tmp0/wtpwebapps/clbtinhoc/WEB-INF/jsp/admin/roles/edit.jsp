...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Cập nhập chức vụ</h1>
	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="row">
					<form action="${pageContext.request.contextPath}/admin/roles/edit/${objRole.id}" method="post">
						<div class="col-lg-12 ">
							<div class="form-group">
								<label>Chức vụ</label> 
								<input  class="form-control" type="text" name="role" value="${objRole.role}">
							</div>
